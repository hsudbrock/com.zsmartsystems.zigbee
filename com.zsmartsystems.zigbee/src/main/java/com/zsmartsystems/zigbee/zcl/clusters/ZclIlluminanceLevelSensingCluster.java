...
public class ZclIlluminanceLevelSensingCluster extends ZclCluster {
    ...
    protected Map<Integer, ZclAttribute> initializeAttributes() {
        ...
        attributeMap.put(ATTR_LEVELSTATUS, new ZclAttribute(ZclStandardClusterType.ILLUMINANCE_LEVEL_SENSING, ATTR_LEVELSTATUS, "LevelStatus", ZclDataType.ENUMERATION_8_BIT, true, true, false, true));
        attributeMap.put(ATTR_LIGHTSENSORTYPE, new ZclAttribute(ZclStandardClusterType.ILLUMINANCE_LEVEL_SENSING, ATTR_LIGHTSENSORTYPE, "LightSensorType", ZclDataType.ENUMERATION_8_BIT, false, true, false, false));
        attributeMap.put(ATTR_ILLUMINANCETARGETLEVEL, new ZclAttribute(ZclStandardClusterType.ILLUMINANCE_LEVEL_SENSING, ATTR_ILLUMINANCETARGETLEVEL, "IlluminanceTargetLevel", ZclDataType.UNSIGNED_16_BIT_INTEGER, false, true, false, false));
