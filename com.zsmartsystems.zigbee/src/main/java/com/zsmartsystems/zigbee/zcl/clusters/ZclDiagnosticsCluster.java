...
public class ZclDiagnosticsCluster extends ZclCluster {
    ...
    protected Map<Integer, ZclAttribute> initializeAttributes() {
        ...
        attributeMap.put(ATTR_MACRXBCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACRXBCAST, "MacRxBcast", ZclDataType.UNSIGNED_32_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MACTXBCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACTXBCAST, "MacTxBcast", ZclDataType.UNSIGNED_32_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MACRXUCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACRXUCAST, "MacRxUcast", ZclDataType.UNSIGNED_32_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MACTXUCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACTXUCAST, "MacTxUcast", ZclDataType.UNSIGNED_32_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MACTXUCASTRETRY, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACTXUCASTRETRY, "MacTxUcastRetry", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MACTXUCASTFAIL, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_MACTXUCASTFAIL, "MacTxUcastFail", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSRXBCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSRXBCAST, "APSRxBcast", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSTXBCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSTXBCAST, "APSTxBcast", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSRXUCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSRXUCAST, "APSRxUcast", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSTXUCASTSUCCESS, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSTXUCASTSUCCESS, "APSTxUcastSuccess", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSTXUCASTRETRY, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSTXUCASTRETRY, "APSTxUcastRetry", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSTXUCASTFAIL, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSTXUCASTFAIL, "APSTxUcastFail", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_ROUTEDISCINITIATED, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_ROUTEDISCINITIATED, "RouteDiscInitiated", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NEIGHBORADDED, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_NEIGHBORADDED, "NeighborAdded", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NEIGHBORREMOVED, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_NEIGHBORREMOVED, "NeighborRemoved", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NEIGHBORSTALE, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_NEIGHBORSTALE, "NeighborStale", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_JOININDICATION, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_JOININDICATION, "JoinIndication", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_CHILDMOVED, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_CHILDMOVED, "ChildMoved", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NWKFCFAILURE, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_NWKFCFAILURE, "NWKFCFailure", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSFCFAILURE, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSFCFAILURE, "APSFCFailure", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSUNAUTHORIZEDKEY, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSUNAUTHORIZEDKEY, "APSUnauthorizedKey", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NWKDECRYPTFAILURES, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_NWKDECRYPTFAILURES, "NWKDecryptFailures", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_APSDECRYPTFAILURES, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_APSDECRYPTFAILURES, "APSDecryptFailures", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_PACKETBUFFERALLOCATEFAILURES, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_PACKETBUFFERALLOCATEFAILURES, "PacketBufferAllocateFailures", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_RELAYEDUCAST, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_RELAYEDUCAST, "RelayedUcast", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_PHYTOMACQUEUELIMITREACHED, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_PHYTOMACQUEUELIMITREACHED, "PhytoMACqueuelimitreached", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_PACKETVALIDATEDROPCOUNT, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_PACKETVALIDATEDROPCOUNT, "PacketValidatedropcount", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_AVERAGEMACRETRYPERAPSMESSAGESENT, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_AVERAGEMACRETRYPERAPSMESSAGESENT, "AverageMACRetryPerAPSMessageSent", ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_LASTMESSAGELQI, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_LASTMESSAGELQI, "LastMessageLQI", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_LASTMESSAGERSSI, new ZclAttribute(ZclStandardClusterType.DIAGNOSTICS, ATTR_LASTMESSAGERSSI, "LastMessageRSSI", ZclDataType.SIGNED_8_BIT_INTEGER, true, true, false, false));
