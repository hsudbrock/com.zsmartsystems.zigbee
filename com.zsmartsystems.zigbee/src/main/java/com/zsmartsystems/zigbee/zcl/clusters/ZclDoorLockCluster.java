...
public class ZclDoorLockCluster extends ZclCluster {
    ...
    protected Map<Integer, ZclAttribute> initializeAttributes() {
        ...
        attributeMap.put(ATTR_LOCKSTATE,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_LOCKSTATE, "Lock State",
                ZclDataType.ENUMERATION_8_BIT, true, true, false, false));
        attributeMap.put(ATTR_LOCKTYPE, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_LOCKTYPE, "Lock Type",
                ZclDataType.ENUMERATION_8_BIT, true, true, false, false));
        attributeMap.put(ATTR_ACTUATORENABLED, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_ACTUATORENABLED,
                "Actuator Enabled", ZclDataType.BOOLEAN, true, true, false, false));
        attributeMap.put(ATTR_DOORSTATE,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_DOORSTATE, "Door State",
                ZclDataType.ENUMERATION_8_BIT, true, true, false, false));
        attributeMap.put(ATTR_DOOROPENEVENTS, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_DOOROPENEVENTS,
                "Door Open Events", ZclDataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_DOORCLOSEDEVENTS,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_DOORCLOSEDEVENTS,
                "Door Closed Events", ZclDataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_OPENPERIOD,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_OPENPERIOD, "Open Period",
                ZclDataType.UNSIGNED_16_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_NUMLOCKRECORDSSUPPORTED,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMLOCKRECORDSSUPPORTED,
        ...
        attributeMap.put(ATTR_NUMTOTALUSERSSUPPORTED,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMTOTALUSERSSUPPORTED,
                        "Num Total Users Supported",
                        ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NUMPINUSERSSUPPORTED,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMPINUSERSSUPPORTED, "Num PIN Users Supported",
                        ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NUMRFIDUSERSSUPPORTED,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMRFIDUSERSSUPPORTED,
                        "Num RFID Users Supported",
                        ZclDataType.UNSIGNED_16_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_NUMWEEKDAYSCHEDULESSUPPORTEDPERUSER,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMWEEKDAYSCHEDULESSUPPORTEDPERUSER,
        ...
        attributeMap.put(ATTR_NUMYEARDAYSCHEDULESSUPPORTEDPERUSER,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMYEARDAYSCHEDULESSUPPORTEDPERUSER,
        ...
        attributeMap.put(ATTR_NUMHOLIDAYSCHEDULESSUPPORTEDPERUSER,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_NUMHOLIDAYSCHEDULESSUPPORTEDPERUSER,
                        "Num Holiday Schedules Supported Per User", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true,
                        false, false));
        attributeMap.put(ATTR_MAXPINLENGTH, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_MAXPINLENGTH,
                "Max PIN Length", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MINPINLENGTH, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_MINPINLENGTH,
                "Min PIN Length", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MAXRFIDCODELENGTH,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_MAXRFIDCODELENGTH,
                "Max RFID Code Length", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_MINRFIDCODELENGTH,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_MINRFIDCODELENGTH,
                "Min RFID Code Length", ZclDataType.UNSIGNED_8_BIT_INTEGER, true, true, false, false));
        attributeMap.put(ATTR_ENABLELOGGING, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_ENABLELOGGING,
                "Enable Logging", ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_LANGUAGE, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_LANGUAGE, "Language",
                ZclDataType.CHARACTER_STRING, false, true, true, true));
        attributeMap.put(ATTR_LEDSETTINGS,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_LEDSETTINGS, "LED Settings",
                ZclDataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_AUTORELOCKTIME, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_AUTORELOCKTIME,
                "Auto Relock Time", ZclDataType.UNSIGNED_32_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_SOUNDVOLUME,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_SOUNDVOLUME, "Sound Volume",
                ZclDataType.UNSIGNED_8_BIT_INTEGER, false, true, true, true));
        attributeMap.put(ATTR_OPERATINGMODE, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_OPERATINGMODE,
                "Operating Mode", ZclDataType.ENUMERATION_8_BIT, false, true, true, true));
        attributeMap.put(ATTR_SUPPORTEDOPERATINGMODES,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_SUPPORTEDOPERATINGMODES,
                        "Supported Operating Modes",
                        ZclDataType.BITMAP_16_BIT, true, true, false, false));
        attributeMap.put(ATTR_DEFAULTCONFIGURATIONREGISTER,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_DEFAULTCONFIGURATIONREGISTER,
                        "Default Configuration Register", ZclDataType.BITMAP_16_BIT, true, true, false, false));
        attributeMap.put(ATTR_ENABLELOCALPROGRAMMING, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK,
                ATTR_ENABLELOCALPROGRAMMING, "Enable Local Programming", ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_ENABLEONETOUCHLOCKING, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK,
                ATTR_ENABLEONETOUCHLOCKING, "Enable One Touch Locking", ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_ENABLEINSIDESTATUSLED, new ZclAttribute(ZclStandardClusterType.DOOR_LOCK,
        ...
        attributeMap.put(ATTR_ENABLEPRIVACYMODEBUTTON,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_ENABLEPRIVACYMODEBUTTON,
                        "Enable Privacy Mode Button",
                        ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_WRONGCODEENTRYLIMIT,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_WRONGCODEENTRYLIMIT,
        ...
        attributeMap.put(ATTR_USERCODETEMPORARYDISABLETIME,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_USERCODETEMPORARYDISABLETIME,
                        "User Code Temporary Disable Time", ZclDataType.UNSIGNED_8_BIT_INTEGER, false, true, true,
                        true));
        attributeMap.put(ATTR_SENDPINOVERTHEAIR,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_SENDPINOVERTHEAIR,
                "Send PIN Over The Air", ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_REQUIREPINFORRFOPERATION,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_REQUIREPINFORRFOPERATION,
                        "Require PIN For RF Operation", ZclDataType.BOOLEAN, false, true, true, true));
        attributeMap.put(ATTR_ZIGBEESECURITYLEVEL,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_ZIGBEESECURITYLEVEL,
                "Zigbee Security Level", ZclDataType.ENUMERATION_8_BIT, true, true, false, false));
        attributeMap.put(ATTR_ALARMMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_ALARMMASK, "Alarm Mask",
                ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_KEYPADOPERATIONEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_KEYPADOPERATIONEVENTMASK,
                        "Keypad Operation Event Mask",
                        ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_RFOPERATIONEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_RFOPERATIONEVENTMASK, "RF Operation Event Mask",
                        ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_MANUALOPERATIONEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_MANUALOPERATIONEVENTMASK,
                        "Manual Operation Event Mask",
                        ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_RFIDOPERATIONEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_RFIDOPERATIONEVENTMASK,
                        "RFID Operation Event Mask",
                        ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_KEYPADPROGRAMMINGEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_KEYPADPROGRAMMINGEVENTMASK,
                        "Keypad Programming Event Mask", ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_RFPROGRAMMINGEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_RFPROGRAMMINGEVENTMASK,
                        "RF Programming Event Mask",
                        ZclDataType.BITMAP_16_BIT, false, true, true, true));
        attributeMap.put(ATTR_RFIDPROGRAMMINGEVENTMASK,
                new ZclAttribute(ZclStandardClusterType.DOOR_LOCK, ATTR_RFIDPROGRAMMINGEVENTMASK,
